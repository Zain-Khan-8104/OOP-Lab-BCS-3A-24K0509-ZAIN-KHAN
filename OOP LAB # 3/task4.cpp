// 4. Using the Calculator class from the previous task, redefine the member functions
// setNumbers() and add() outside the class definition. Use the scope resolution operator
// (::) to link the function definitions to the class. Demonstrate the program's functionality in
// main() by setting numbers and displaying their sum.
